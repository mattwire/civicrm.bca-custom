...
{assign var=showFacebook value="1"}
{assign var=showTwitter value="1"}
{assign var=showGoogle value="0"}
{assign var=showLinkedIn value="0"}
{assign var=fbURL value="https://www.facebook.com/eurospeleo2016"}
{assign var=twURL value="http://eurospeleo.uk"}
{assign var=twTags value="eurospeleo2016,eurospeleo,caving"}
{assign var=twText value="I just bought tickets for Eurospeleo 2016!"}
{assign var=mainURL value="http://eurospeleo.uk"}
{assign var=mainTitle value="Eurospeleo 2016"}


<div class="crm-section crm-socialnetwork help">
    <h3 class="nobackground">{ts}Help spread the word{/ts}</h3>
    <div class="description">
        {ts}Please help us and let your friends, colleagues and followers know about {/ts}{if $mainTitle}:
        <span class="bold"><a href="{$mainURL}">{$mainTitle}</a></span>
        {else}.{/if}
    </div>
    <div class="crm-fb-tweet-buttons">
        {if $emailMode eq true}
            ...
            {if $showTwitter}
                <a href="http://twitter.com/share?url={$twURL}&amp;text={$twText}" id="crm_tweet">
            ...
            {/if}
            {if $showFacebook}
                <a href="http://www.facebook.com/plugins/like.php?href={$fbURL}" target="_blank">
        ...
        {else}
            ...
            {if $showTwitter}
                <div class="label">
                    ...
                    src="https://platform.twitter.com/widgets/tweet_button.html?text={$twText}&amp;url={$twURL|escape:'url'}&amp;hashtags={$twTags}"
